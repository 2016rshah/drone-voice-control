...
\begin{document}
	...
	\begin{thebibliography}{1}
		...
		\bibitem{kinect} Jones, G. (2012, November 16). Kinect-drone. Retrieved September 24, 2015, from https://github.com/glennjones/kinect-drone

		\bibitem{droneapi} Geisendörfer, F. (2012, July 21). Node AR Drone. Retrieved September 29, 2015, from https://github.com/felixge/node-ar-drone

		\bibitem{sphinx} Cmusphinx/node-pocketsphinx. (2014, May 25). Retrieved September 29, 2015, from https://github.com/cmusphinx/node-pocketsphinx

		\bibitem{myo} Controlling the Parrot AR.Drone 2.0 with the Myo™ Armband. (2013, October 2). Retrieved September 29, 2015, from http://developerblog.myo.com/controlling-the-parrot-ar-drone-2-0-with-the-myo-armband/
